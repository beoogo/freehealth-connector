...
class SwaggerConfiguration(val typeResolver: TypeResolver) {
    ...
    fun api(): Docket =
        Docket(DocumentationType.SWAGGER_2)
            ...
            .paths(PathSelectors.regex("^/(ab|admin|chap4|consent|consultrn|crypto|gmd|eatt.+|efact|ehb.+|genins|vaccinnet|hub|mda|mhm|mycarenet|recip.+|rnconsult|sts|tarif|therlink|eagreement)(/.*)?"))
            .build()
}
