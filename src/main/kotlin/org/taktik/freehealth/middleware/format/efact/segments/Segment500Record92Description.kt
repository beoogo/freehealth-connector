...
object Segment500Record92Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "507", "Signe Montant demand A + B + C", null, "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "508", "Montant demand compte A + B + C = lien Cpt A", "totalAskedAmount", "N", pos, 11)
