...
object Record30Description : RecordOrSegmentDescription() {
    ...
    override val zoneDescriptionsByZone: Map<String, ZoneDescription>
        ...
        init {
            ...
            pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "24,25", "signe + montant indicatif ordre de grandeur frais de sejour (partie 1 et 2)", null, "N", pos, 12)
            pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "26", "reserve", null, "N", pos, 1)
            pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "27", "signe + intervention personnelle patient", null, "N", pos, 10)
