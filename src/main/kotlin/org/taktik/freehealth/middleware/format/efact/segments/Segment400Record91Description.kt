...
object Segment400Record91Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "419", "Signe total montants acceptes compte A + compte B + compte C", "totalAcceptedAmount", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "420", "Total montants acceptes compte A+compte B + compte C", null, "N", pos, 11)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "4201", "Code erreur", null, "N", pos, 2)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "421", "Signe total montants refuses compte A + compte B + compte C", "totalRejectedAmount", "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "422", "Total montants refuses compte A+compteB + compte C", null, "N", pos, 11)
