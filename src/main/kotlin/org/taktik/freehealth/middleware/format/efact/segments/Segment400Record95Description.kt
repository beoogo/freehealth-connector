...
object Segment400Record95Description : RecordOrSegmentDescription() {
    ...
    init {
        ...
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "407", "Signe Montant demand A + B + C", null, "A", pos, 1)
        pos = register(ZONE_DESCRIPTIONS_BY_ZONE, "408", "Montant demand compte A + B + C = lien Cpt A", null, "N", pos, 11)
